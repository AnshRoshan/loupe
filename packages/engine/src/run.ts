...
export async function runReview(
  ...
  // Blocking tier: explicit EngineConfig wins; otherwise the repo's
  // .aireview.toml `blocking_severities` (default [] = advisory COMMENT).
  const blockingSeverities = config.blockingSeverities ?? repoConfig.blockingSeverities;
  ...
  // blockingSeverities opts into the blocking tier: a published finding at or
  // above the floor submits the review as REQUEST_CHANGES instead of COMMENT.
